            ...
            <div class="col-lg-12">
                ...
                <div class="card callout callout-primary pt-4 pl-4">
                    ...
                    <p class="pt-2" id="counter_pack">
                        Practical Lesson Package : <span class="badge badge-primary"> <?= round((intval($pack_online[0]['total_pack_practical']) - intval(count($count_pratical))) / 2) ?> package (<?= intval($pack_online[0]['total_pack_practical']) - intval(count($count_pratical)) ?> meeting)</span> <br>
                        Theory Lesson Package : <span class="badge badge-primary"> <?= intval($pack_online[0]['total_pack_theory']) - intval(count($count_theory)) ?> package (<?= intval($pack_online[0]['total_pack_theory']) - intval(count($count_theory)) ?> meeting)</span>
                    </p>
                    <p class="hiden">
